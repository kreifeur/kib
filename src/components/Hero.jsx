...
const Hero = () => {
  return (
    <div className="h-[90vh] w-full flex items-center justify-center flex-col gap-6">
      <div className=" px-5 py-1 font-bold sm:text-5xl text-2xl sm:w-[80%] w-[100%] bg-gradient-to-r from-black via-gray-500 to-indigo-400 inline-block text-transparent bg-clip-text">
